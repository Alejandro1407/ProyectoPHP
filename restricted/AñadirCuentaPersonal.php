<?php
    ...
    $conn = new conexion;
    $rs = $conn->ExecuteQuery("SELECT Id,CONCAT(Nombre,' ',Apellidos) AS Nombres,Email FROM Usuario WHERE TipoUsuario = 2");
?>
<h4 class="grey-text mt-5 mt-md-0 mt-xl-0 mt-lg-0 h4-responsive">Añadir Cuenta Personal</h4><br>
...
<script>
    $(document).ready(function(){
        $('#btnAccept').on('click',function(){
            ...
            $.ajax({
                type:'POST',
                url:'/ProyectoPHP/lib/Restricted/añadircuentapersonal.php',
