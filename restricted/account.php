...
<?php 
    ...
    $conn = new conexion;
    $Id = $_COOKIE['Id'];
    $rs = $conn->ExecuteQuery("SELECT u.Id,CONCAT(u.Nombre,' ',u.Apellidos ) AS Nombres, u.Email, u.Pass, u.Edad, IF(u.Sexo = 'M','Masculino','Femenino') AS Sexo FROM Usuario u WHERE u.Id = $Id");
    $x = $rs[0];
?>
<div class="row">
