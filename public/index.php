<?php
    ...
    base::Head("Home","StyleIndex"); //Incluye la cabecera e importa los css
    ...
    <!-- Inicio del contendio del sitio WEB -->
        ...
        <div class="container-fluid wow slideInUp Lato" id="Title">
            ...
            <div class="ml-auto mr-auto d-block" class="Titulo">
                <a href="#DivServicios" class="btn btn-red">Comenzar</a>
            </div>
            <br>
        </div>
       
        <div class="bg-white pb-5 panel font-weight-bold pt-5" id="DivServicios">
            <img class="float-xl-left  mr-5 wow slideInUp img-fluid" src="/ProyectoPHP/img/Servicios.png" alt="servicos_icon" width="300" heigth="300">
        ...
        <div class="bg-white pb-5 panel font-weight-bold pt-5" id="DivSucursales">
                <img class="float-left mr-5 wow slideInUp img-fluid" src="/ProyectoPHP/img/Equipo.png" alt="Equipo" width="300" heigth="300">
